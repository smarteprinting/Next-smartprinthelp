      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-6">
            Smarter printing starts here. Discover top-rated printers, exceptional value, and dedicated support — only at Smart Print Help.
          </p>
          {/* Social Icons */}
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><Link href="/" className="text-red-500 hover:text-red-400 transition">Home</Link></li>
            <li><Link href="/about/" className="text-gray-300 hover:text-white transition">About Us</Link></li>
            <li><Link href="/shop/" className="text-gray-300 hover:text-white transition">Shop</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link href="/return-refund-policy/" className="text-gray-300 hover:text-white transition">Return and Refund Policy</Link></li>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-gray-300">
            <p>23224 Crenshaw Blvd, Torrance, CA 90505</p>
            <p>Email : <span className="text-white">support@smartprinthelp.com</span></p>

            <p>Website : <a href="https://www.smartprinthelp.com" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition">www.smartprinthelp.com</a></p>
          </div>
        </div>
